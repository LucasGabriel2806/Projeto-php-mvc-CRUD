...
class FuncionarioDAO
{
    ...
    /**
     * Retorna um registro específico da tabela funcionario do banco de dados.
    ...
    public function selectById(int $id)
    {
        ...
        return $stmt->fetchObject("FuncionarioModel"); // Retornando um objeto específico FuncionarioModel
    }
